          ...
          <div className="max-w-2xl mx-auto py-16 px-6">
            ...
            {payments?.mode === "test" && (
              <div className="mb-6 px-4 py-3 rounded-xl border border-sky-400/40 bg-sky-500/10 text-sky-700 dark:text-sky-300 text-xs leading-relaxed">
                stripe test mode. use card <span className="font-mono">4242 4242 4242 4242</span> with any future expiry and
          ...
          <div className="max-w-md mx-auto py-16 px-6">
            ...
            {account && (
              <div className="mb-4 px-4 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50 flex items-center justify-between gap-3">
                ...
                {account.premium ? (
                  <span className="px-2 py-0.5 rounded-md bg-sky-500/15 text-sky-600 dark:text-sky-400 text-[10px] font-medium shrink-0">
                    premium
                  </span>
                ) : (
                  <button
                    ...
                    className="text-[10px] text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 shrink-0 transition-colors"
                  >
                    use another account
                  </button>
                )}
